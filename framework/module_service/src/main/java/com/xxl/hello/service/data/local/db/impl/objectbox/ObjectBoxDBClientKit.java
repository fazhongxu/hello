...
public class ObjectBoxDBClientKit implements DBClientKit {
    ...
    public boolean switchDatabase(@NonNull String targetUserId) {
        synchronized (this) {
            ...
            if (TextUtils.equals(dataBaseName, mDatabaseName) && mBoxStore != null && !mBoxStore.isClosed()) {
                return true;
            }
            ...
            if (BuildConfig.DEBUG) {
                boolean start = new Admin(mBoxStore)
                        .start(mApplication);
    ...
    public void closeDatabase() {
        synchronized (this) {
            if (mBoxStore == null || mBoxStore.isClosed()) {
                return;
            }
            mBoxStore.close();
            mBoxStore = null;
    ...
    public boolean isClosed() {
        synchronized (this) {
            return mBoxStore != null && mBoxStore.isClosed();
        }
    }
