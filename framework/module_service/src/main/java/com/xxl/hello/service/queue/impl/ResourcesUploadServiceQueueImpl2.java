 ...
 * @date 2022/5/27.
 */
public class ResourcesUploadServiceQueueImpl2 extends BaseServiceQueueImpl2 implements ResourcesUploadServiceQueue2 {
    ...
    public ResourcesUploadServiceQueueImpl2(@NonNull final Application application,
    ...
    public void onEventMainThread(@Nullable final OnPutResources2UploadQueueEvent event) {
        ...
        if (getQueueStatus() != ServiceQueueRunningStatus.RUNNING) {
            start();
            // TODO: 2025/5/7
        }
    }
