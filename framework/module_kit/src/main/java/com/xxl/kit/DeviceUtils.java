...
public final class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) AppUtils.getApplication()
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) AppUtils.getApplication().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(AppUtils.getApplication().getPackageManager()) == null;
        if (checkDial) {
            return true;
        }
