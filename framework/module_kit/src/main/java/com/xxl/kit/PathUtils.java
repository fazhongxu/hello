...
/**
 * 路径相关工具类
 * reference https://github.com/xuexiangjys/XUtil/blob/master/xutil-core/src/main/java/com/xuexiang/xutil/app/PathUtils.java
 *
 * @author xxl.
 * @date 2021/7/26.
 */
public class PathUtils {
    ...
    public static String getAppIntDbPath(String name) {
        return AppUtils.getApplication().getDatabasePath(name).getAbsolutePath();
    }
    ...
    public static String getAppExtCachePath() {
        return getFilePath(AppUtils.getApplication().getExternalCacheDir());
    }
    ...
    public static String getAppExtFilePath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(null));
    }
    ...
    public static String getAppExtAlarmsPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getAppExtDCIMPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getAppExtDocumentsPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getAppExtDownloadPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getAppExtMoviesPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getAppExtMusicPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getAppExtNotificationsPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getAppExtPicturesPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getAppExtPodcastsPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getAppExtRingtonesPath() {
        return getFilePath(AppUtils.getApplication().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static Uri getMediaContentUri(File mediaFile) {
        return getMediaContentUri(AppUtils.getApplication(), mediaFile);
    }
    ...
    public static Uri getUriByFile(final File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && !Environment.isExternalStorageLegacy() && isPublicPath(file)) {
            String filePath = file.getAbsolutePath();
            if (filePath.startsWith(EXT_DOWNLOADS_PATH)) {
                return getDownloadContentUri(AppUtils.getApplication(), file);
            } else if (filePath.startsWith(EXT_PICTURES_PATH) || filePath.startsWith(EXT_DCIM_PATH)) {
                return getMediaContentUri(AppUtils.getApplication(), file);
            } else {
    ...
    public static File uri2File(final Uri uri, final String columnName) {
        ...
        CursorLoader cl = new CursorLoader(AppUtils.getApplication());
        cl.setUri(uri);
    ...
    public static String getFilePathByUri(Uri uri) {
        return getFilePathByUri(AppUtils.getApplication(), uri);
    }
