...
/**
 * 可折叠和展开文本的自定义View
 * reference https://github.com/zly394/CollapsedTextView
 *
 * @author xxl.
 * @date 2023/01/7.
 */
public class CollapsedTextView extends AppCompatTextView implements View.OnClickListener {
     ...
     * 折叠时的默认文本
     */
    private static final String EXPANDED_TEXT = StringUtils.getString(R.string.resources_unfold_text);

    /**
     * 展开时的默认文本
     */
    private static final String COLLAPSED_TEXT = StringUtils.getString(R.string.resources_collapse_text);
     ...
     * @return
     */
    public ExpandedClickableSpan getClickableSpan() {
     ...
     * 设置是否响应点击事件
     *
     * @param isResponseListener
     */
    public void setResponseListener(boolean isResponseListener) {
        this.mIsResponseListener = isResponseListener;
    }
    ...
    public void setText(final CharSequence text, final TextView.BufferType type) {
        ...
        if (TextUtils.isEmpty(text) || mCollapsedLines == 0) {
            ...
            // 保存原始文本，去掉文本末尾的空字符
            this.mOriginalText = StringUtils.trim(text.toString());
    ...
    //region: Inner Class ExpandedClickableSpan
    ...
    //region: Inner Enums TipsGravityMode
