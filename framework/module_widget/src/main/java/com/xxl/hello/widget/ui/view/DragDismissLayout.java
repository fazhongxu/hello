...
/**
 * 仿微信推动图片返回效果
 * reference https://github.com/yuanyang1991/DragDismissLayout/blob/master/lib/src/main/java/com/example/lib/DragDismissLayout.java
 *
 * @author xxl.
 * @date 2022/10/9.
 */
public class DragDismissLayout extends ViewGroup {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                doScale(currentTop);
                int alpha = computeAlpha(currentTop);
                colorDrawable.setAlpha(alpha);
                actionDownY = currentY;
                actionDownX = currentX;
                if (mOnDragListener != null) {
                    mOnDragListener.onDragging(alpha);
                }
                break;
    ...
    public void setDefaultColorDrawable() {
    ...
    public interface OnDragListener {
         ...
         * @param alpha
         */
        default void onDragging(int alpha) {
