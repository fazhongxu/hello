...
public class PileLayout extends ViewGroup {
    ...
    public PileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mVerticalSpace = ta.getDimension(R.styleable.PileLayout_verticalSpace, DisplayUtils.dp2px(4));
        mPileWidth = ta.getDimension(R.styleable.PileLayout_pileWidth, DisplayUtils.dp2px(10));
        ta.recycle();
    }
