 ...
 * @date 2022/10/19.
 */
public class RequestErrorState extends BaseState {

    //region: 成员变量

    public static final String STATE = "RequestErrorState";

    public static final String EVENT_CLICK = "RequestErrorState_CLICK";
    ...
    protected int getLayoutId() {
        return R.layout.core_layout_request_error_state;
    }
