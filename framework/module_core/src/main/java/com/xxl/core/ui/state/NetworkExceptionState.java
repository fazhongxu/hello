 ...
 * @date 2022/10/19.
 */
public class NetworkExceptionState extends BaseState {

    //region: 成员变量

    public static final String STATE = "NetworkExceptionState";
    ...
    protected int getLayoutId() {
        return R.layout.core_layout_network_exception_state;
    }
