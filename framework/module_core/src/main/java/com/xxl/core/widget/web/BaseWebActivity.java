 ...
 * @date 2022/6/25.
 */
public abstract class BaseWebActivity extends SwipeBackActivity implements RefreshWebView.OnWebCallBack {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRefreshWebView = findViewById(R.id.refresh_web_view);
        setupToolbarLayout();
        initWebView(mRefreshWebView);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        mRefreshWebView.release();
    }
