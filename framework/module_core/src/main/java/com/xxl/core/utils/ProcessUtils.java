...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AppUtils.getApplication().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppUtils.getApplication().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AppUtils.getApplication().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AppUtils.getApplication()
    ...
    public static boolean isMainProcess() {
        return AppUtils.getApplication().getPackageName().equals(getCurrentProcessName());
    }
