...
public final class PreferencesUtils {
    ...
    private static final Map<String, PreferencesUtils> SP_UTILS_MAP = new HashMap<>();
    ...
    public static PreferencesUtils getInstance(String spName, final int mode) {
        ...
        PreferencesUtils preferencesUtils = SP_UTILS_MAP.get(spName);
    ...
    private PreferencesUtils(final String spName) {
