...
public class NotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(AppUtils.getApplication()).areNotificationsEnabled();
    }
    ...
    public static void notify(String tag, int id, ChannelConfig channelConfig, Utils.Consumer<NotificationCompat.Builder> consumer) {
        NotificationManagerCompat.from(AppUtils.getApplication()).notify(tag, id, getNotification(channelConfig, consumer));
    }
    ...
    public static Notification getNotification(ChannelConfig channelConfig, Utils.Consumer<NotificationCompat.Builder> consumer) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) AppUtils.getApplication().getSystemService(Context.NOTIFICATION_SERVICE);
            //noinspection ConstantConditions
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationCompat.Builder builder = new NotificationCompat.Builder(AppUtils.getApplication());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(AppUtils.getApplication()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(AppUtils.getApplication()).cancel(id);
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = AppUtils.getApplication().getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                AppUtils.getApplication().getPackageName(), AppUtils.getApplication().getPackageName(), IMPORTANCE_DEFAULT
        );
