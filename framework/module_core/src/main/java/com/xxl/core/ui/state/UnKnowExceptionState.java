 ...
 * @date 2022/10/19.
 */
public class UnKnowExceptionState extends BaseState {

    //region: 成员变量

    public static final String STATE = "UnKnowExceptionState";
    ...
    protected int getLayoutId() {
        return R.layout.core_layout_unknow_exception_state;
    }
