...
public final class PinyinHelper {
    ...
    public static void addPinyinDict(String path) throws IOException {
        PINYIN_TABLE.putAll(PinyinResource.getResource(AppUtils.getApplication(), path));
    }

    public static void addMutilPinyinDict(String path) throws FileNotFoundException {
        MUTIL_PINYIN_TABLE.putAll(PinyinResource.getResource(AppUtils.getApplication(),path));
        dict.clear();
